...
<p align="center">
  <strong>ML Engineer</strong> · 5 years building production ML systems in healthcare & fintech<br>
  NLP · RAG · LLMs · MLOps · Data Engineering
</p>
...
I work across the full ML stack — from raw data pipelines to deployed models and dashboards. Currently at **Cigna Healthcare**, where I own NLP pipelines that process 1M+ claims records per month and a RAG system that cut manual lookup time by 40%.
...
- **Data Scientist** @ Capgemini *(Aug 2021 – Aug 2023)*
- **Junior ML Engineer** @ ACS Technologies *(Apr 2020 – Feb 2021)*

---

<p align="center">
  <em>Open to ML/AI engineering roles. Feel free to reach out!</em>
</p>
